...
Ses gousses sont remplies d'une soie creuse, très légère et naturellement hydrophobe. On la
...
Je remonte ça une fois : la diffusion est jeudi le 17 à 20 h sur CBC et CBC Gem.

Si le sujet ne vous convient pas, aucun problème, je ne relancerai pas une deuxième fois.
```
