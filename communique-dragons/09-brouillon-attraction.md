# Attraction — Dans l'œil du dragon

Pas de la presse : la production qui a auditionné Gabriel le 29 juin 2026 pour la 16e saison
de *Dans l'œil du dragon* (Radio-Canada). Silence depuis, deux mois.

**Destinataires**, trouvés dans Missive avec le filtre `all=true&domain=attraction.ca` :

| Adresse | Personne | Rôle |
| --- | --- | --- |
| `kgingras@attraction.ca` | Karine Gingras | Productrice au contenu |
| `alasselin@attraction.ca` | Anne-Laurie Asselin | Recherchiste |

Angélique Caron-St-Pierre, la troisième recherchiste présente à l'audition, n'a jamais écrit :
son adresse n'est nulle part dans la boîte. On ne la devine pas.
...
Aucune signature : Missive ajoute la sienne.
