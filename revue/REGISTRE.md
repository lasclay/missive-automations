...
- **Décidé le** : 2026-09-09
- **Note** : Reportee le 9 septembre apres verification. La proposition supposait que le tir A etait interrompu ; l'examen de douze jours de journal montre autre chose : ses publications ET ses ecarts se sont effondres ensemble le 4 septembre (60 a 115 elements traites par jour jusqu'au 3, puis 2 a 9). Un seuil de trois creneaux vides declencherait donc une alerte INTERROMPUE chaque jour sur le tir A sans qu'on sache si elle est juste — exactement le faux positif que sa propre clause de risque annoncait. Je ne propose pas de variante : il faut d'abord savoir pourquoi le tir voit si peu, ce que le depot ne dit pas.
