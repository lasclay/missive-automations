...
Document unique de la vague 2. Il remplace `VAGUE-2-FACEBOOK.md` et `messages-vague-2.md`, dont il
reprend tout le contenu. Le corpus brut reste dans `facebook-avis-negatifs.md`.

Source : les deux Loom de la page Facebook (4 min 19 et 14 min). Le second est pris depuis le
compte propriétaire, fils de commentaires déroulés, et remonte jusqu'au 4 août 2026. Page à 90 % de
recommandations sur 208 avis. Facebook n'a pas d'étoiles, seulement « recommends » ou
« doesn't recommend ».

**Tout ce qui suit a été vérifié dans Shopify, dans ShipStation et dans Missive le 25 août.** Les
avis Facebook donnent des prénoms et des récits, pas des numéros de commande. Le travail
d'identification est fait ici et il change plusieurs dossiers du tout au tout.

**Quinze personnes. Treize messages, un dossier bloqué faute de fait vérifiable, une personne à ne
pas contacter.**

✅ **Les treize messages sont partis le 25 août**, depuis Missive, un fil neuf par personne.
Identifiants de conversation dans `avis-negatifs/envoi-v2/journal.json`. Aucun geste n'a été exécuté
avant l'envoi : chaque message propose, et rien ne part tant que la personne n'a pas répondu.

## Ce que cette vague n'a pas en commun avec la première

Sur Google, chaque avis est isolé. Sur Facebook, **les clients se répondent entre eux**. Sous
l'avis d'Emilie Lamothe, quatre personnes viennent confirmer à la file, et Nathalie Girouard écrit
« je pense qu'il faut faire une plainte au Consomateur ». Un avis négatif en attire d'autres.

Conséquence pratique : répondre publiquement à ces avis-là ne suffit pas, parce que la
conversation vit dans les commentaires. Et deux personnes de ce fil sont allées jusqu'à la
rétrofacturation.

---

## Les règles d'écriture, reprises de la vague 1

1. Salutation. 2. **D'où on sort**, formulé différemment chaque fois. 3. **La citation de l'avis**,
mot pour mot. 4. **Le point précis**. 5. **L'excuse**, une seule fois, jamais en ouverture.
6. **Le geste, proposé**, en prose, chiffré, sans condition. 7. **Une vraie question**.
...
## Le geste est proposé, pas exécuté

**Décision du 25 août, et c'est ce qui distingue cette vague de la première.** Aucun message
n'annonce un remboursement ou une carte-cadeau comme un fait accompli. Chacun **propose** le geste,
chiffré, sans condition, et attend un mot de la personne avant que quoi que ce soit parte.

La vague 1 a fait l'inverse : quinze messages annonçant « vos 119,55 $ vous sont remboursés » au
présent, et le jour même deux clientes écrivaient pour dire qu'elles ne voyaient rien sur leur
relevé. L'écart entre ce qu'un message annonce et ce qui est réellement exécuté est exactement le
reproche que cette campagne répare. En proposant, il n'y a plus d'écart possible.

⚠️ **Proposer n'est pas conditionner.** La demande de mise à jour reste en dernier, détachée, et
elle est suivie de « ça ne change rien à ce que je viens de vous offrir ». Un geste offert sans
condition et une demande explicitement facultative restent conformes aux règles de Google comme à
la Loi sur la protection du consommateur. Ce qui serait interdit, c'est « si vous modifiez votre
avis, je vous envoie une carte », et ça n'apparaît nulle part.

**Ce qu'il faudra exécuter, une fois les réponses reçues :**

| Client | Ce qui est proposé |
| --- | --- |
| **Selena / Hugo Poirier** | attendre la fin septembre **ou** 51,42 $ remboursés, pourboire compris, plus une carte de 100 $ |
| Danielle René | une étiquette de retour prépayée, émise à sa demande |
| Amandine Caudron | les 50 $ promis en décembre 2024 + une carte de 100 $ |
| Colette D'Astous | une paire de mitaines en médium si elle la veut + une carte de 100 $ |
| Marie-Annick Duquette | une carte de 100 $ |
| David Morin | une carte de 100 $ |
| Jézabelle Paquin | la fusion de ses deux fiches client + une carte de 100 $ |
| Martine Savard | le cache-cou manquant + 42,99 $ + une carte de 100 $ |
| Gilles Coulombe | la paire de mitaines manquante **ou** 126,46 $, plus une carte de 100 $ |
| Magali Élias GF | rien, trois questions |
| Gabrielle Champagne | rien, une demande |
| Francine Poirier | rien, un merci |
| Estelle Waché | une carte de 100 $ |

**Plafond si tout le monde accepte : 800 $ en cartes**, plus 42,99 $, 126,46 $, 51,42 $ et les 50 $
d'Amandine. En pratique, une partie ne répondra pas, et rien ne sera engagé pour ceux-là.

---

# Les quinze dossiers

Chaque dossier donne d'abord ce que les systèmes établissent, puis le message qui en découle.


---

## 1. Selena Hugo St-denis Poirier · 4 août 2026 · `poirierhugo@hotmail.com` · **LE DOSSIER OUVERT**

**Niveau : Commande encore ouverte · le choix, puis 100 $**

### Ce que les systèmes établissent
...
>
> Le prochain lot de coussins entre vers la fin septembre. C'est la vraie date, et si elle bouge je vous écris sans que vous ayez à demander. À partir de là, deux chemins et les deux me vont : ou bien vous attendez, et le coussin part le jour où le lot entre, par colis suivi avec le numéro dans ce fil, ou bien vous ne voulez plus attendre, ce qui se comprend après deux mois et demi, et je vous rembourse les 51,42 $ au complet, pourboire compris, dès que vous me le dites. Répondez-moi « j'attends » ou « rembourse », c'est tout ce que ça prend. Dans les deux cas je voudrais y ajouter une carte-cadeau de 100 $ sans date d'expiration, alors dites-moi juste si vous l'acceptez.
>
> Et si le cœur vous en dit une fois la situation réglée, une mise à jour de votre avis nous aiderait vraiment. Aucune obligation, et ça ne change rien à ce que je viens de vous offrir.
...
## 2. Danielle René · 25 février 2026 · `la_cyberdan@yahoo.ca`

**Niveau : Excuses seules · l'étiquette de retour promise**

### Ce que les systèmes établissent

> « Commande passée il y a un mois, paiement passé immédiatement, confirmation de commande puis
...
*L-46045, 154 jours, rétrofacturation gagnée par elle. ⚠️ **Rien de financier** : elle a le manteau
et son argent. Ce qui reste dû, c'est l'étiquette de retour promise le 16 juillet.*

*⚠️ **Aucune demande de mise à jour dans ce message.** Elle a écrit « est-ce qu'il y a un humain qui
peut me répondre????? » et elle a dû passer par MasterCard. Lui demander un service par-dessus ça
annulerait les excuses. Décision à renverser si Gabriel préfère.*

> **Objet : Le retour de votre manteau**
>
> Bonjour Danielle,
>
...
>
> Le 16 juillet je vous ai promis une étiquette de retour prépayée et elle n'est jamais partie. Je peux vous l'émettre aujourd'hui, sans aucuns frais pour vous : dites-moi seulement si vous voulez toujours retourner le manteau et elle part dans l'heure. Et si vous préférez le garder, gardez-le : il est à vous, sans rien à payer.
>
...
## 3. Amandine Caudron · 17 janvier 2025 · `lamydu04@msn.com`

**Niveau : Excuses · les 50 $ promis en 2024, puis 100 $**
...
*Colis perdu par GLS, remplacement reçu le 28 janvier 2025, rétrofacturation gagnée par elle.
⚠️ **Les 50 $ promis le 21 décembre 2024 sont à vérifier dans l'admin avant l'envoi.** Aucune
commande à 0,00 $ n'existe à son nom.*

*⚠️ **Ne jamais mentionner la rétrofacturation ni la demande de la retirer.***

> **Objet : Votre commande de novembre 2024, dix-neuf mois plus tard**
>
> Bonjour Amandine,
>
...
>
> Le remplacement est bel et bien parti, le 28 janvier, mais personne ne vous a écrit pour vous le dire et personne n'a jamais demandé s'il était arrivé. Je le demande maintenant, avec dix-neuf mois de retard : est-ce que les mitaines et le cache-cou se sont rendus jusqu'à vous? Les 50 $ promis en décembre, j'aimerais vous les envoyer pour de bon, avec une carte-cadeau de 100 $ par-dessus, sans date d'expiration. Confirmez-moi l'adresse où les recevoir et les deux partent.
>
> Vous aviez écrit que vous espériez parler de nous en bien dans l'Outaouais, et je n'ai rien fait pour mériter ça à l'époque. Si le cœur vous en dit, une mise à jour de votre avis nous aiderait vraiment. Aucune obligation, et ça ne change rien à ce que je viens de vous offrir.


---

## 4. Colette D'Astous · 25 novembre 2025 · `colettedastous@gmail.com`
...
*Tuque échangée le 1er décembre. ⚠️ **Sa question sur les mitaines est restée huit mois sans
réponse**, et elle n'a pas répondu à l'offre du 15 juillet. ⚠️ **Elle s'était excusée de son propre
avis.** C'est une relance chaleureuse, pas une réparation.*

> **Objet : Vos mitaines, huit mois plus tard**
>
> Bonjour Colette,
>
...
## 5. Marie-Annick Duquette · 28 février 2026 · `mannick72@hotmail.com`

**Niveau : Fort · 100 $**

### Ce que les systèmes établissent

Trois semaines à essayer de retourner une veste achetée pour sa mère âgée et qui ne lui va pas.
Aucune réponse par courriel ni par Messenger.

**L-46545, 5 février 2026, 282,82 $.** Veste sans manche Femme 2XL + bandeau torsadé rouge.
Expédiée le lendemain, 6 février.

**Remboursée de 238,35 $ le 5 mars 2026**, soit **cinq jours après son avis**. Trois semaines de
silence, puis un avis public, puis un remboursement en cinq jours. Elle garde le bandeau, 44,47 $.

⚠️ **Ne pas lui présenter le remboursement comme un démenti.** Quand elle a écrit, rien n'avait
bougé depuis trois semaines. Son grief était fondé et c'est son avis qui a débloqué le dossier.
Même règle qu'Ariane Poirier à la vague 1.

### Le message

*L-46545, veste + bandeau, remboursée de 238,35 $ le 5 mars, soit cinq jours après son avis.
⚠️ **Ne pas présenter le remboursement comme un démenti.** Quand elle a écrit, rien n'avait bougé
depuis trois semaines.*

> **Objet : Le retour de la veste de votre mère**
>
...
>
> Un retour, ça devrait prendre deux courriels. Le vôtre a pris trois semaines de silence, puis un avis public, puis cinq jours : autrement dit, il a fallu que vous écriviez sur Facebook pour qu'on s'occupe de vous. Je m'en excuse. Le remboursement de 238,35 $ est parti le 5 mars, vous avez gardé le bandeau, et c'est correct comme ça. Ce que je voudrais ajouter, c'est une carte-cadeau de 100 $ sans date d'expiration : dites-moi si vous l'acceptez et elle part.
>
...
>
> Et si le cœur vous en dit, une mise à jour de votre avis nous aiderait vraiment. Aucune obligation, et ça ne change rien à ce que je viens de vous offrir.


---

## 6. David Morin · 22 décembre 2025 · `david.morin@compass-canada.com`
...
**L-43082, 7 décembre 2025, 126,46 $, mitaines plein air XL.** Expédiée le **23 décembre**, seize
jours plus tard, soit **le lendemain de son avis**. Une carte-cadeau de 50 $ (L-44824) lui a été
émise le même 23 décembre.

✅ **L'hypothèse du rapprochement se confirme.** L'avis Google de « David » daté du 23 décembre
2025 décrit la même commande de mitaines, le même délai, un jour d'écart. **David Morin sur
Facebook et David sur Google sont la même personne**, et il apparaît donc **deux fois** dans le
corpus. Une seule réparation, deux avis à traiter.

### Le message

*L-43082, mitaines XL, expédiée le 23 décembre, soit le lendemain de son avis Facebook, avec une
carte-cadeau de 50 $ le même jour. ⚠️ **Il a aussi un avis Google du 23 décembre**, sur la même
commande. Une seule réparation, deux avis.*

> **Objet : Vos mitaines de décembre**
>
> Bonjour David,
>
...
>
> Quatre courriels, Facebook, Instagram, et rien sur aucun des trois : ce n'est pas une boîte qui déborde, c'est une boîte que personne n'ouvrait. Je m'en excuse. Vos mitaines sont parties le 23 décembre, le lendemain de votre avis, ce qui veut dire que vous avez obtenu en un jour, en écrivant en public, ce que quatre courriels n'avaient pas obtenu en trois semaines. C'est ça le vrai problème, et c'est celui qu'on a bouché depuis, en passant d'un service client inexistant à une équipe qui répond. Ce que je peux faire aujourd'hui, c'est vous envoyer une carte-cadeau de 100 $ sans date d'expiration, en plus de celle de 50 $ de décembre : dites-moi si vous la voulez et elle part.
>
...
## 7. Jézabelle Paquin · 24 décembre 2025 · `jezabellep@hotmail.com`

**Niveau : Fort · fusionner les fiches, puis 100 $**
...
*L-43656, précommande d'avant Noël, carte-cadeau de 25 $ le jour de son avis.
⚠️ **Deux fiches client à son nom** : `jezabellep@hotmail.com` porte ses commandes,
`jezabellepaquin@gmail.com` n'en porte aucune. C'est pour ça que son compte paraissait vide.*

*⚠️ **Ne pas se défendre sur la précommande.** La réponse publique lui opposait déjà l'article de
janvier, avec une capture d'écran annotée de sa commande. Ne pas y revenir.*

> **Objet : Votre compte qui paraissait vide**
>
> Bonjour Jézabelle,
>
...
>
> Je fusionne les deux comptes cette semaine et vos deux commandes vont apparaître ensemble, sous l'adresse de votre choix : dites-moi laquelle vous voulez garder. Et j'aimerais vous envoyer une carte-cadeau de 100 $ sans date d'expiration, en plus de celle de 25 $ de décembre, si vous l'acceptez.
>
> Et si le cœur vous en dit, une mise à jour de votre avis nous aiderait vraiment. Aucune obligation, et ça ne change rien à ce que je viens de vous offrir.
...
## 8. Martine Savard · 29 décembre 2025 · `martinette222@hotmail.com`

**Niveau : Fort · l'article manquant, 42,99 $, puis 100 $**
...
*Deux commandes en décembre. L-44108 portait **deux** cache-cou gris foncé au bordereau, elle en a
reçu un. Les deux expéditions sont parties **sans numéro de suivi**.*

> **Objet : Le cache-cou qui manquait dans votre deuxième commande**
>
> Bonjour Martine,
>
...
>
> J'ai vérifié : votre commande du 14 décembre contient bien deux cache-cou gris foncé, vous en avez reçu un, et elle est partie sans numéro de suivi, donc je n'ai même pas de quoi retracer le deuxième. Quatre messages là-dessus sans réponse, par-dessus le marché. Je m'en excuse. Le deuxième cache-cou, je peux vous l'envoyer cette semaine et vous rembourser celui qui manquait, 42,99 $, ce qui ferait que vous recevez les deux et n'en payez qu'un. Confirmez-moi votre adresse et je pars ça. Il y a aussi une carte-cadeau de 100 $ à votre nom si vous la voulez.
>
...
>
> Et si le cœur vous en dit une fois le colis arrivé, une mise à jour de votre avis nous aiderait vraiment. Aucune obligation, et ça ne change rien à ce que je viens de vous offrir.


---

## 9. Gilles Coulombe · en commentaire seulement · `coulombegilles@gmail.com`

**Niveau : Fort · la paire manquante ou 126,46 $, puis 100 $**
...
*Cinq commandes, 762,14 $. Il n'a jamais publié d'avis, il s'est plaint deux fois sous ceux des
autres. **L-46684, 7 février 2026, 508,47 $** : expédiée le 25 mars, soit 46 jours, et le bordereau
ShipStation ne contient **qu'une** des deux paires de mitaines facturées.*

*⚠️ **Pas de demande de mise à jour** : il n'a pas d'avis à mettre à jour. Ses commentaires publics
sont sous les avis d'autres personnes, et lui demander d'y toucher serait déplacé.*

> **Objet : La deuxième paire de mitaines de votre commande de février**
>
> Bonjour Gilles,
>
...
>
> Dites-moi laquelle des deux vous avez reçue, la rouge ou la rouge et gris pâle, et je vous envoie l'autre par colis suivi. Si vous préférez l'argent, je vous rembourse les 126,46 $, à vous de choisir. Et dans les deux cas j'aimerais y ajouter une carte-cadeau de 100 $, sans date d'expiration.
>
...
## 10. Magali Élias GF · 11 janvier 2026 · `magali.guilbault@gmail.com` · **le seul avis de conception**

**Niveau : Trois questions · aucun argent**
...
*Tuque, manchons remboursés en entier, deux vestes en M et en L, 185,46 $ remboursés le 5 février,
soit 25 jours après son avis. ⚠️ **Les semelles qu'elle mentionne n'apparaissent dans aucune de ses
commandes.** Ne rien affirmer là-dessus. ⚠️ **Aucune carte-cadeau** : elle a déjà été remboursée
deux fois et son grief n'est pas financier.*

> **Objet : Vos quatre produits, et les quatre défauts**
>
> Bonjour Magali,
>
...
## 11. John Belliveau · 7 septembre 2025 · `john.belliveau@proton.me`

**Niveau : ⚠️ Bloqué · compter les graines d'abord**

### Ce que les systèmes établissent

Sachets de semences et bombes semencières commandés au printemps. Les sachets devaient contenir
50 graines, l'un en contenait **12**. Semés à quatre endroits, un seul plant a levé.

**L-33942, 1er mai 2025, 41,47 $ :** 1 sachet d'asclépiade incarnate + 10 bombes semencières
d'asclépiade tubéreuse. Exactement ce qu'il décrit.

⚠️ **Le seul avis du corpus qui met en cause le contenu réel d'un produit.** C'est vérifiable et
ça doit l'être **avant** de lui répondre : combien de graines part-il réellement dans un sachet, et
la fiche produit annonce-t-elle 50? Tant que la réponse n'est pas connue, ne rien lui écrire. Un
message qui nierait un défaut réel serait pire que le silence.

---

### Le message

*L-33942, 1er mai 2025, 41,47 $, un sachet d'asclépiade incarnate + 10 bombes semencières
tubéreuses. Il dit avoir compté **12 graines dans un sachet annoncé à 50**.*

⚠️ **Pas de brouillon.** Deux choses manquent, et ce sont des faits, pas de la rédaction : combien
de graines part-il réellement dans un sachet, et qu'est-ce que la fiche produit annonçait en mai
2025? Tant que ces deux réponses ne sont pas connues, tout message dirait soit une chose fausse,
soit rien. Un message qui nierait un défaut réel serait pire que le silence.


---

## 12. Gabrielle Champagne · 2 mars 2023 · `gabriellechampagne@live.ca` · **le plus facile**

**Niveau : Demande de mise à jour seule · aucun argent**
...
*L-10778, mitaines L + S, partiellement remboursée. Puis L-11476, échange de grandeur XS le
14 janvier 2023. Son avis dit lui-même que tout est réglé. ⚠️ **Rien à réparer, rien à offrir.**
C'est une demande de mise à jour, et c'est tout.*

> **Objet : Votre avis de 2023, et une demande**
>
> Bonjour Gabrielle,
>
...
## 13. Francine Poirier · `franp22@bell.net`

**Niveau : Remerciement · aucun argent**

### Ce que les systèmes établissent

**L-42397, 1er décembre 2025, 164,37 $** (bandeau en précommande, foulard, cache-cou, étui). Son
avis parlait de « 167 $ de produits début décembre » : c'est la bonne commande.
**L-44675, 21 décembre : carte-cadeau de 25 $**, exactement le choix qu'elle décrit avoir fait.

Puis elle a **racheté deux fois** : une veste à 248,34 $ le 6 février 2026, et des manchons le
20 juin 2026. Et elle a modifié son propre avis : « j'ai finalement reçu ma commande et un suivi
par courriel de leur part, je suis satisfaite de mes achats ».

**Cliente reconquise, deux fois, sans qu'on lui dise merci.** Un remerciement, rien d'autre.

### Le message

*L-42397, 164,37 $ le 1er décembre. Carte-cadeau de 25 $ le 21 décembre, exactement le choix qu'elle
décrit. Puis **deux rachats** : une veste à 248,34 $ le 6 février et des manchons le 20 juin. Elle a
modifié son propre avis pour dire qu'elle avait été servie. ⚠️ **Rien à réparer.***

> **Objet : Merci pour la mise à jour de votre avis**
>
> Bonjour Francine,
>
...
## 14. Estelle Waché · `estebene@yahoo.ca`

**Niveau : Remerciement et question · 100 $**

### Ce que les systèmes établissent

**L-18992, 1er décembre 2023, 160,92 $**, deux paires de semelles + mitaines M. Remboursée de
**104,97 $ le 16 janvier 2024**, cinq jours après son avis du 11 janvier. Même schéma que
Marie-Annick : le silence, puis l'avis, puis le règlement en cinq jours.

Et surtout : **elle a racheté des mitaines** (L-41726, 22 novembre 2025, mitaines urbaines +
deux paires de semelles), après avoir écrit publiquement que les nôtres étaient « beaucoup trop
raides ».

⚠️ **C'est le meilleur test qu'on ait sur la raideur.** Elle a la version 2023 et la version 2025
dans la même maison. Lui demander laquelle tient mieux vaut plus qu'un remboursement.

### Le message

*L-18992, décembre 2023, remboursée de 104,97 $ le 16 janvier 2024, cinq jours après son avis. Et
surtout : **elle a racheté des mitaines** en novembre 2025, après avoir écrit publiquement que les
nôtres étaient trop raides. ⚠️ **C'est le meilleur test qu'on ait sur la raideur.***

> **Objet : Vos mitaines de 2023 et celles de 2025**
>
> Bonjour Estelle,
>
...
>
> Est-ce que la nouvelle est plus souple? C'est la question sur laquelle on tourne en rond, parce que personne d'autre n'a les deux, et votre réponse vaut plus que tous nos tests internes. Pour le dérangement de 2024, j'aimerais aussi vous envoyer une carte-cadeau de 100 $ sans date d'expiration : dites-moi seulement si vous l'acceptez.
>
> Et si les nouvelles vous ont satisfaite, une mise à jour de votre avis nous aiderait vraiment. Aucune obligation, et ça ne change rien à ce que je viens de vous offrir.
...
## 15. Mylène Van Winden · `mylene.antoine@hotmail.com`

**Niveau : Ne rien envoyer**

### Ce que les systèmes établissent

L-11882, 6 février 2023, 39,08 $, un bandeau. Elle a confirmé elle-même en commentaire : « Commande
reçu aujourd'hui ! ». Rien à faire.
...
Aucun. Elle a écrit elle-même « Commande reçu aujourd'hui ! ». Rien à réparer, rien à demander.
...
qu'elles ne seront pas identifiées, et **aucune hypothèse ne doit se transformer en fait** dans un
message.
...
**Le plus important des cinq est Stéphane Provost** : « manteau mal isolé » est le seul grief du
corpus qui vise l'isolation, c'est-à-dire la promesse centrale du produit le plus cher.
...
# Ce que la vague révèle en amont

Trois choses qui ne se règlent pas par un message.

**Le coussin d'assise est survendu de 57 unités.** `Coussin d'assise thermal pliable` affiche un
inventaire de **-57**, et le combo `manchons + coussin isotherme` de **-71**. Le grief de Nathalie
Girouard, un coussin sur deux jamais livré mais facturé, n'est donc pas un incident : c'est le
même mécanisme que les sacs à lunch du printemps 2026. Tant que la disponibilité s'affiche mal
avant le paiement, la vague 3 s'écrit toute seule.

**Deux défauts produits neufs, absents de Google.** La finition des cache-cou (Kim Vincent, plus
l'avis d'Emilie Lamothe sur un cache-cou mal fini et sans étiquette) et le nombre de graines par
sachet (John Belliveau). Les deux sont vérifiables en production et doivent l'être avant qu'on
réponde.

**Le défaut de tenue de la fibre se confirme sur trois produits.** La raideur des mitaines chez
Estelle Waché comme chez Nathalie Durand sur Google, et les semelles qui plissent chez Jimmy
Allaire. Trois clients, trois produits, un même problème de structure autour de la fibre.


---

# Identifiés, mais sans dossier ouvert
...
| # | Client | Ce qui est proposé | Carte offerte | Avis à demander |
| --- | --- | --- | --- | --- |
| 1 | **Selena / Hugo Poirier** | le choix : attendre la fin septembre **ou** 51,42 $ remboursés, pourboire compris | 100 $ | oui |
| 2 | Danielle René | l'**étiquette de retour prépayée** promise le 16 juillet | aucune | **non, volontairement** |
| 3 | Amandine Caudron | les **50 $ promis en décembre 2024**, à vérifier dans l'admin | 100 $ | oui |
| 4 | Colette D'Astous | la paire en médium si elle la demande | 100 $ | oui |
| 5 | Marie-Annick Duquette | rien, déjà remboursée de 238,35 $ | 100 $ | oui |
| 6 | David Morin | rien, déjà livré et déjà 50 $ en décembre | 100 $ | oui, **deux avis** |
| 7 | Jézabelle Paquin | **fusionner ses deux fiches client** | 100 $ | oui |
| 8 | Martine Savard | le **cache-cou manquant** + 42,99 $ | 100 $ | oui |
| 9 | Gilles Coulombe | la **paire de mitaines manquante** ou 126,46 $ | 100 $ | **non**, il n'a pas d'avis |
| 10 | Magali Élias GF | rien, trois questions sur les défauts | aucune | non |
| 11 | John Belliveau | ⚠️ **bloqué**, compter les graines d'un sachet | — | — |
| 12 | Gabrielle Champagne | rien, une demande | aucune | **oui, c'est tout le message** |
| 13 | Francine Poirier | rien, un merci | aucune | oui |
| 14 | Estelle Waché | rien, une question sur la raideur | 100 $ | oui |
| 15 | Mylène Van Winden | rien | aucune | non |

**Plafond de 800 $ en cartes si les huit acceptent**, plus 42,99 $ à Martine Savard, 126,46 $ ou
une paire de mitaines à Gilles Coulombe, 51,42 $ ou un coussin à Selena, et les 50 $ d'Amandine
s'ils n'ont jamais été émis. Rien n'est engagé tant que la personne n'a pas répondu.

**Treize messages prêts. Un bloqué. Une personne à ne pas contacter. Quatre encore à identifier.**

## Les trois choix de rédaction qui se discutent

**Danielle René n'a aucune demande de mise à jour.** Elle a écrit « est-ce qu'il y a un humain qui
peut me répondre????? » et elle a dû passer par MasterCard pour récupérer son argent. Lui demander
un service par-dessus ça annulerait les excuses.

**Selena / Hugo Poirier n'a pas de prénom dans son message.** L'avis est signé « Selena Hugo
St-denis Poirier », la commande est au nom de Hugo Poirier. Choisir au hasard, c'est risquer
d'écrire au mauvais membre du couple.

**Gilles Coulombe non plus n'a pas de demande.** Il n'a jamais publié d'avis, ses plaintes sont des
commentaires sous les avis d'autres personnes. Lui demander d'y toucher serait déplacé.

## ⚠️ La leçon de la vague 1, appliquée ici

**Aucun texte de cette vague n'annonce un geste comme accompli.** Chacun le propose et attend un
mot. La vague 1 a envoyé quinze messages annonçant un remboursement au présent, et le jour même
deux clientes écrivaient pour dire qu'elles ne le voyaient pas sur leur relevé.

**Donc : envoyer d'abord, exécuter à la réponse.** C'est l'inverse de la vague 1, et c'est ce qui
supprime l'écart.
