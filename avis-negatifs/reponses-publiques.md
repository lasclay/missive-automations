...
> Bonjour Marie,
>
> Vous avez raison sur le fond. Depuis 2025, l'assemblage textile de la plupart de nos produits
> finis se fait à l'extérieur du Québec, surtout en Tunisie. Ce qui reste ici : la culture de
> l'asclépiade, la transformation de la soie en isolant, la conception et le contrôle qualité.
...
Même ossature partout : reconnaître le tort en une phrase, dire ce qui a changé en une phrase,
ouvrir une porte. Elles ne doivent pas se ressembler mot pour mot, Google lit la répétition comme
du gabarit.

## Emma Nelson · 1★ · juin 2026 · anglais

*⚠️ Il s'agit très probablement d'Emma Whiten, commande L-50672, **remboursée le 20 août**. Ne
rien lui offrir qui a déjà été fait.*

> Hi Emma,
>
> Three emails with no answer is indefensible, and the wait on top of it made it worse. Our
> support backlog got away from us this spring, and yours is the kind of message that should never
...
> Hi Tim,
>
> We told you we would investigate and come back with a solution, and then we did not. That is the
> part I am sorry about.
>
> Your order went out as stamped mail with no tracking, so neither of us had any way to find it.
> We stopped shipping seed that way. Write to hey@lasclay.com and I will make it right the same
> day, reshipment or refund, your call.
>
> Gabriel, co-founder
...
>
> Vos deux premiers messages ne se sont pas rendus jusqu'à nous, et c'était notre système. On a
> refait depuis la façon dont les courriels et les messages Messenger sont pris en charge.
>
> Gabriel, cofondateur
...
> défendre là-dedans : décembre nous a dépassés.
>
> Les messages Messenger en particulier ne se rendaient pas jusqu'à la bonne personne, et c'est le
> premier trou qu'on bouche. Si quelque chose reste en suspens de votre côté, écrivez à
> hey@lasclay.com.
>
> Gabriel, cofondateur
...
> que ce soit, c'est une promesse rompue au moment de payer. Vous avez raison de le dire.
>
> On est en train de corriger la façon dont les disponibilités s'affichent, pour qu'un produit qui
> part en production le dise avant le paiement. Si vous voulez qu'on regarde votre dossier,
> hey@lasclay.com.
>
> Gabriel, cofondateur
...
> Bonjour Annie,
>
> Devoir écrire un avis public pour obtenir une réponse à une demande de retour, c'est un échec
> complet de notre part. Douze jours de silence pendant les fêtes ne s'excusent pas par le volume.
>
...
> Bonjour Sonia,
>
> Vous aviez pris la peine de préciser que le produit lui-même n'était pas en cause, et on vous a
> quand même laissée sans réponse. Un échange de grandeur ne devrait jamais demander des semaines.
>
...
> échec. Un défaut de fabrication se remplace, point.
>
> Si ce n'est toujours pas réglé, écrivez à hey@lasclay.com et on le remplace sans retour à faire.
>
> Hi Toby, same in English: a manufacturing defect is ours to replace, and you should never have
> had to ask more than once. Write to hey@lasclay.com and we will replace it, no return needed.
>
> Gabriel, cofondateur
...
> Bonjour Nathalie,
>
> Des mitaines trop rigides pour le sport, c'est un vrai défaut, et on vous l'avait confirmé. Vous
> laisser ensuite sans réponse après plusieurs suivis, il n'y a pas d'excuse pour ça.
>
...
*Sa dernière phrase demande si l'entreprise existe encore. C'est la seule de la liste où répondre
sert d'abord à rassurer un lecteur, pas l'autrice.*
...
>
> Pour répondre à votre question : oui, Lasclay est toujours en activité. Les délais sont annoncés
> à l'achat et les commandes sortent avec un suivi. Si votre dossier n'a jamais été réglé,
> hey@lasclay.com.
>
> Gabriel, cofondateur
