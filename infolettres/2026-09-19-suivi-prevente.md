...
Rappel du piège : l'assistant de campagne édite la **copie** (`YnZvAC` / `U6vrBD`),
pas le gabarit de bibliothèque.

## Structure (identique dans les deux langues)

1. Bilan : 494 commandes le 12 septembre, plus grosse journée de 2026 en nombre de
   commandes ; la production part de ces commandes-là.
2. Les six produits partis le plus vite, avec les quantités et un lien par produit.
3. La lecture sur la matière : soie ~20 % du poids de la cocotte, graines ~30 % ;
   quatre des dix plus vendus viennent de la graine (boîte d'essai, savon, crème
   contour des yeux, pinces brunes au tourteau).
...
6. Dragons' Den diffusé le 17 septembre, épisode sur CBC Gem. Aucune mention du
...
- 494 commandes le 12 sept. contre 431 le 30 mai 2026, la deuxième meilleure journée.
...
- Diffuser le nombre de commandes (494) et les quantités par produit, ou non.
- Le passage Dragons' Den ne dit rien de l'issue du tournage, faute d'information
  vérifiée ici.
