...
fl(3,(tw-4,crotch_y),(-6,tip_y+6),(34,22))
m=((tw-4-6)/2,(crotch_y+tip_y+6)/2)
fl(4,(-12,m[1]+14),(tw-2,m[1]-16),(-40,-8))
fl(5,(-4,H),(-7,tip_y+8),(-26,40))
fl(6,(4,POI+1),(W-4,POI+1),(46,0))
fl(7,(-4,H-3),(W+4,H-3),(0,-26))
cx,cy=P(W/2,H+22); rx=(W+8)/2*S
out.append(f'<ellipse cx="{cx:.1f}" cy="{cy:.1f}" rx="{rx:.1f}" ry="17" fill="none" stroke="{COL[8]}" stroke-width="3.2"/>'+badge(8,cx,cy))
...
Wc,Hc=int(P(W+60,0)[0])+10,int(P(0,H+45)[1])+10
...
{''.join(out)}
<text x="{P(W/2,0)[0]:.1f}" y="{P(0,H+45)[1]:.1f}" font-size="14" text-anchor="middle" fill="#555" font-family="Helvetica,Arial,sans-serif">Mitaine finie, côté paume, posée à plat — taille M à l’échelle</text>
</svg>'''
