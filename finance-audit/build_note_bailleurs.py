...
# Le système visuel — palette, graphiques SVG, feuille de style, pied de
# page — vit dans `design_pdf.py`, partagé avec le mémo de Wassim et la
# proposition de partenariat.
from design_pdf import *          # noqa: F401,F403
from design_pdf import fr, pct, foot, hbar, bar_chart, legend, \
    combo_chart, ramp_chart, stack_chart, moteurs_chart, mois_chart, \
    cercle_chart, fibre_chart, rendre, CSS, MOIS, INK, VERT, \
    VERT_CLAIR, VERT_PALE, ORANGE, ORANGE_PALE, GRIS, PAPIER, LIGNE, YR
