...
GLOSSAIRE = {
    ...
    '• Ce que la bascule révèle : la marge de crédit était tirée à 143 026 $ au 31 juillet 2026, alors que le modèle projetait 27 825 $. Le sommet des mois projetés — août 2026 à août 2029 — s’établit à 145 305 $ en août 2027, soit 15 305 $ au-dessus de la limite de 130 000 $ retenue. Le modèle ne bride pas le tirage : plafonner cacherait le besoin au lieu de le montrer (Inputs, rangées 163 à 167).':
        '• What the switch reveals: the credit line was drawn at $143,026 at 31 July 2026, where the model projected $27,825. The peak across the forecast months — August 2026 to August 2029 — is $145,305 in August 2027, $15,305 above the $130,000 limit assumed. The model does not cap the draw: capping would hide the need instead of showing it (Inputs, rows 163 to 167).',
    ...
    '• Conséquence, et c’est le point : le tirage de marge de crédit au 31 août 2026 passe de 25 248 $ à 134 812 $. Les 110 000 $ d’écart n’étaient pas une prévision, c’était l’artefact de la frontière. Le contrôle d’Inputs (rangée 166) balayait de septembre 2026 à août 2029 et sautait donc août 2026, le mois du sommet ; il part maintenant d’août 2026.':
        '• The consequence, and this is the point: the credit line drawn at 31 August 2026 goes from $25,248 to $134,812. The $110,000 gap was not a forecast, it was the artefact of the boundary. The Inputs control (row 166) swept September 2026 to August 2029 and therefore skipped August 2026, the peak month; it now starts at August 2026.',
    ...
    '• Constat de clôture, scénario conservateur : 2025-2026 se referme sur 977 339 $ de ventes nettes et -122 613 $ avant impôts, dont onze mois réels. La marge de crédit demandée culmine à 145 305 $ en août 2027 — le creux saisonnier d’avant-saison, deux fois de suite. C’est le chiffre du dossier : la limite autorisée de 130 000 $ ne suffit pas, il en faut 150 000 $.':
        '• Closing observation, conservative scenario: 2025-2026 closes at $977,339 of net sales and −$122,613 before tax, of which eleven months are actual. The credit line requested peaks at $145,305 in August 2027 — the pre-season trough, two years running. That is the figure for the file: the $130,000 authorised limit is not enough, $150,000 is needed.',
