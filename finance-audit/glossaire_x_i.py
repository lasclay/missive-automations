...
GLOSSAIRE = {
    ...
    # ------------------------------------------- phase AZ : la facilité EDC
    '• Ce que la bascule révèle : la marge de crédit était tirée à 143 026 $ au 31 juillet 2026, alors que le modèle projetait 27 825 $. Le sommet des mois projetés — août 2026 à août 2029 — s’établit à 141 878 $ en août 2027, sous la facilité EDC de 150 000 $ mais à 8 122 $ près. Le modèle ne bride pas le tirage : plafonner cacherait le besoin au lieu de le montrer (Inputs, rangées 163 à 167).':
        '• What the switch reveals: the credit line was drawn at $143,026 at 31 July 2026, where the model projected $27,825. The peak across the forecast months — August 2026 to August 2029 — is $141,878 in August 2027, under the $150,000 EDC facility but only just, by $8,122. The model does not cap the draw: capping would hide the need instead of showing it (Inputs, rows 163 to 167).',
    '• Constat de clôture, scénario conservateur : 2025-2026 se referme sur 977 339 $ de ventes nettes et -122 613 $ avant impôts, dont onze mois réels. La marge de crédit culmine à 143 026 $ — le réel du 31 juillet 2026 — et le sommet projeté atteint 141 878 $ en août 2027, le creux d’avant-saison deux étés de suite. La facilité EDC de 150 000 $ tient, à 8 122 $ près, mais elle est déjà tirée à 95 % : c’est le fonds de roulement qui manque, pas la limite.':
        '• Closing observation, conservative scenario: 2025-2026 closes at $977,339 of net sales and −$122,613 before tax, of which eleven months are actual. The credit line peaks at $143,026 — the 31 July 2026 actual — and the forecast peak reaches $141,878 in August 2027, the pre-season trough two summers running. The $150,000 EDC facility holds, by $8,122, but it is already 95% drawn: what is missing is working capital, not headroom.',
    '• Corrigé : le classeur portait 130 000 $ comme « marge de crédit autorisée » (Inputs D164), une constante sans source, pendant que le compte du grand livre s’appelle « 2022 Marge de crédit - EDC LC1 - 150K » et que la section 06 du mémo calcule le coussin restant sur 150 000 $. Le contrôle annonçait donc 11 878 $ de dépassement d’une limite qui n’est pas la bonne. La valeur passe à 150 000 $ ; la lettre d’autorisation reste à verser au dossier.':
        '• Corrected: the workbook carried $130,000 as the “authorised credit line” (Inputs D164), a constant with no source, while the general ledger account is named “2022 Marge de crédit - EDC LC1 - 150K” and section 06 of the memo computes the remaining cushion on $150,000. The control was therefore reporting an $11,878 overrun of the wrong limit. The value becomes $150,000; the authorisation letter still needs to go on file.',
    'Facilité EDC LC1. Le compte du grand livre s’appelle « 2022 Marge de crédit - EDC LC1 - 150K » et la section 06 du mémo en tire le coussin restant au 31 juillet 2026. Le classeur a porté 130 000 $ un temps, sans source. À confirmer par la lettre d’autorisation.':
        'EDC LC1 facility. The general ledger account is named “2022 Marge de crédit - EDC LC1 - 150K” and section 06 of the memo derives the remaining cushion at 31 July 2026 from it. The workbook carried $130,000 for a while, with no source. To be confirmed by the authorisation letter.',
    'Le sommet est juillet 2026, et c’est du réel : la marge EDC était tirée à 143 026 $ au 31 juillet, soit 6 974 $ sous la facilité autorisée.':
        'The peak is July 2026, and it is actual: the EDC line was drawn at $143,026 at 31 July, $6,974 below the authorised facility.',
    'Zéro : le sommet projeté tient sous la facilité existante, avec 8 122 $ de marge. Le tirage n’est pas bridé dans le modèle — si l’hypothèse de vente se dégrade, le dépassement apparaîtra ici.':
        'Zero: the forecast peak fits under the existing facility, with $8,122 to spare. The draw is not capped in the model — if the sales assumption weakens, the overrun will show up here.',

    # ------------------------------ pourquoi l'été 2026 est à presque zéro
    '• Pourquoi juin et juillet 2026 sont à 9 054 $ et 1 491 $ de ventes nettes : l’activité de l’été a été arrêtée, pas subie. Servir la saison chaude demandait de produire au Québec, et l’été 2025 l’avait déjà chiffré — juin et juillet 2025 dégagent 30 % et 58 % de contribution marginale contre 80 % et 72 % en novembre et décembre, et ne couvrent pas leurs frais généraux (-3 376 $ pour les deux mois, avant vente, marketing, administration et financement). L’entreprise a arrêté la production québécoise, mis à pied les employés de production et transféré l’assemblage à l’étranger.':
        '• Why June and July 2026 show $9,054 and $1,491 of net sales: the summer’s activity was stopped, not endured. Serving the warm season meant producing in Quebec, and the summer of 2025 had already priced that — June and July 2025 deliver 30% and 58% contribution margin against 80% and 72% in November and December, and do not cover their general expenses (−$3,376 for the two months, before selling, marketing, administration and financing). The company stopped Quebec production, laid off the production staff and moved assembly offshore.',
    '• Ce que les livres montrent de cette décision, de mai à juillet : la main-d’œuvre de production passe de 35 675 $ à 4 328 $ (-88 %) et la publicité numérique de 79 599 $ à 9 172 $ (-88 %), pendant que les achats de matières premières montent de 35 550 $ à 52 719 $ (+48 %). Une entreprise à court d’argent coupe ses achats ; ceux-ci montent. C’est un stock constitué d’avance pour un assemblage fait ailleurs, pas une rupture de trésorerie. La publicité suit la production : on n’achète pas de la demande qu’on ne pourrait servir qu’à perte.':
        '• What the books show of that decision, from May to July: production labour goes from $35,675 to $4,328 (−88%) and digital advertising from $79,599 to $9,172 (−88%), while raw material purchases rise from $35,550 to $52,719 (+48%). A company short of cash cuts its purchases; these rise. That is inventory built ahead for assembly done elsewhere, not a cash breakdown. Advertising follows production: you do not buy demand you could only serve at a loss.',

    # -------------------- phase BB : la saisonnalité du moteur, retrouvée
    '• Corrigé, et c’est le défaut le plus lourd trouvé à ce jour : le résultat ne lisait du moteur de ventes que son TOTAL ANNUEL, qu’il redistribuait sur douze mois avec des coefficients codés en dur (8,96 % · 5,20 % · 17,42 % · 24,73 % · 12,62 % · 10,02 % · 5,50 % · 3,90 % · 9,65 % · 1,19 % · 0,27 % · 0,54 %). Ces douze nombres sont le profil mensuel de 2025-2026 : ils reportaient jusqu’en 2029 l’été volontairement arrêté (juin, juillet et août à 2,0 % de l’année) et la prévente unique du 30 mai 2026 (mai à 9,65 %). Chaque mois projeté lit maintenant son propre mois du moteur, où chaque produit porte sa courbe de douze mois.':
        '• Corrected, and it is the heaviest defect found so far: the income statement read only the ANNUAL TOTAL of the sales engine, which it redistributed across twelve months using hard-coded coefficients (8.96% · 5.20% · 17.42% · 24.73% · 12.62% · 10.02% · 5.50% · 3.90% · 9.65% · 1.19% · 0.27% · 0.54%). Those twelve numbers are the monthly profile of 2025-2026: they carried the deliberately stopped summer (June, July and August at 2.0% of the year) and the one-off 30 May 2026 pre-sale (May at 9.65%) all the way to 2029. Each forecast month now reads its own month from the engine, where every product carries its own twelve-month curve.',
    '• Ce que la correction change : le total annuel ne bouge pas d’un dollar — la somme des douze mois du moteur est exactement le total que les coefficients redistribuaient. Ce qui bouge, c’est quand le revenu rentre. La part de juin, juillet et août passe de 2,6 % à 6,8 % en 2026-2027, de 3,3 % à 6,9 % en 2027-2028 et de 3,7 % à 6,9 % en 2028-2029. Le tirage de marge de crédit projeté le plus élevé passe de 141 878 $ à 141 295 $.':
        '• What the correction changes: the annual total does not move by a dollar — the sum of the engine’s twelve months is exactly the total the coefficients were redistributing. What moves is when the revenue arrives. The share of June, July and August goes from 2.6% to 6.8% in 2026-2027, from 3.3% to 6.9% in 2027-2028 and from 3.7% to 6.9% in 2028-2029. The highest forecast credit line draw goes from $141,878 to $141,295.',
    '• Corrigé aussi : sur les 36 mois projetés, les rangées 9, 10 et 11 (B2C-CAN, B2C-USA, B2B) et leur total, la rangée 3, ne portaient rien — tout le revenu vivait sur la rangée 5. L’état des résultats affichait « Ventes B2C -CAN : 0 » de septembre 2026 à août 2029. Les trois canaux sont ventilés comme ils l’étaient déjà en août 2026 (85,6 % · 7,7 % · 6,7 %), la rangée 3 redevient le total des ventes en ligne, et les rangées 17, 18 et 25 y renvoient : les 48 mois ont désormais la même forme.':
        '• Also corrected: across the 36 forecast months, rows 9, 10 and 11 (B2C-CAN, B2C-USA, B2B) and their total, row 3, carried nothing — all the revenue lived on row 5. The income statement showed “Ventes B2C -CAN: 0” from September 2026 to August 2029. The three channels are now split as they already were in August 2026 (85.6% · 7.7% · 6.7%), row 3 becomes the online sales total again, and rows 17, 18 and 25 point at it: all 48 months now have the same shape.',

    # ------------------------- phase BC : un troisième scénario sur C70
    'Scénario actif : OPTIMISTE (trajectoire de la proposition de juillet 2026)':
        'Active scenario: OPTIMISTIC (the July 2026 proposal’s trajectory)',
    'SCÉNARIO ACTIF → 1 = conservateur réaliste (bailleurs) 2 = ambitieux (investisseur privé) 3 = optimiste (trajectoire de la proposition de juillet 2026)':
        'ACTIVE SCENARIO → 1 = realistic conservative (lenders)  2 = ambitious (private investor)  3 = optimistic (the July 2026 proposal’s trajectory)',
    'Conservateur (C70 = 1)': 'Conservative (C70 = 1)',
    'Ambitieux (C70 = 2)': 'Ambitious (C70 = 2)',
    'Optimiste (C70 = 3)': 'Optimistic (C70 = 3)',
    'Optimiste : la trajectoire annoncée en juillet 2026, mais portée par les deux moteurs. La version de juillet atteignait 4,17 M$ avec le seul commerce en ligne, à 61,7 % de croissance par année, et ignorait le canal détail. Ici le détail se déploie au rythme ambitieux — 101 points de vente au 31 août 2029 — et le commerce en ligne n’a plus à porter seul l’ambition.':
        'Optimistic: the trajectory announced in July 2026, but carried by both engines. The July version reached $4.17M on e-commerce alone, at 61.7% growth a year, and ignored the retail channel. Here retail rolls out at the ambitious pace — 101 points of sale at 31 August 2029 — and e-commerce no longer has to carry the ambition on its own.',
    'Le scénario optimiste reprend les facteurs ambitieux relevés de 0,146 — le même écart pour toutes les catégories, résolu pour que les ventes nettes de 2028-2029 retrouvent la trajectoire de la proposition de juillet 2026 (4,17 M$). Les paramètres de coût et le plan d’embauche restent ceux du scénario ambitieux : l’optimisme porte sur le volume, pas sur la structure.':
        'The optimistic scenario takes the ambitious factors raised by 0.146 — the same increment for every category, solved so that 2028-2029 net sales land back on the July 2026 proposal’s trajectory ($4.17M). The cost parameters and the hiring plan stay those of the ambitious scenario: the optimism is about volume, not about the cost structure.',
    '• La bascule Inputs C70 porte maintenant trois lectures : 1 = conservateur réaliste, 2 = ambitieux, 3 = optimiste. La troisième remet le classeur sur la trajectoire annoncée dans la proposition de partenariat de juillet 2026 — 4,17 M$ de ventes nettes en 2028-2029 — mais en la construisant avec les deux moteurs. La version de juillet atteignait ce montant avec le seul commerce en ligne, à 61,7 % de croissance annuelle, et ignorait le canal détail ; ici le détail se déploie au rythme ambitieux et le commerce en ligne n’a plus à porter seul l’ambition.':
        '• The Inputs C70 switch now carries three readings: 1 = realistic conservative, 2 = ambitious, 3 = optimistic. The third puts the workbook back on the trajectory announced in the July 2026 partnership proposal — $4.17M of net sales in 2028-2029 — but builds it with both engines. The July version reached that figure on e-commerce alone, at 61.7% annual growth, and ignored the retail channel; here retail rolls out at the ambitious pace and e-commerce no longer has to carry the ambition on its own.',
    '• Comment le scénario optimiste est posé : ses facteurs de croissance sont ceux du scénario ambitieux relevés de 0,146, le même écart pour les six catégories et les trois exercices, résolu par bissection sur les ventes nettes de 2028-2029. Un seul écart plutôt que six jugements séparés. Les paramètres de coût — matières, sous-traitance, publicité — et le plan d’embauche restent ceux du scénario ambitieux : l’optimisme porte sur le volume, pas sur la structure de coûts.':
        '• How the optimistic scenario is set: its growth factors are those of the ambitious scenario raised by 0.146, the same increment across the six categories and the three years, solved by bisection on 2028-2029 net sales. One increment rather than six separate judgements. The cost parameters — materials, subcontracting, advertising — and the hiring plan stay those of the ambitious scenario: the optimism is about volume, not about the cost structure.',
    '• Mécanique : les 36 formules qui lisaient IF(C70=2, ambitieux, conservateur) deviennent IF(C70=3, optimiste, IF(C70=2, ambitieux, conservateur)) là où le scénario optimiste a sa propre valeur — les douze facteurs de croissance et le profil de 2028-2029, colonne G d’Inputs — et IF(C70>=2, ambitieux, conservateur) partout ailleurs. Écrire une colonne de valeurs identiques à celles d’à côté ferait croire qu’elles peuvent diverger.':
        '• Mechanics: the 36 formulas that read IF(C70=2, ambitious, conservative) become IF(C70=3, optimistic, IF(C70=2, ambitious, conservative)) wherever the optimistic scenario has its own value — the twelve growth factors and the 2028-2029 profile, column G of Inputs — and IF(C70>=2, ambitious, conservative) everywhere else. Writing a column of values identical to the one next to it would suggest they can diverge.',
}
